...
[assembly: ExportRenderer(typeof(StyleListItem), typeof(StyleListItemRenderer))]
namespace mobile_style_editor
{
    public class StyleListItemRenderer : ClickViewRenderer
	{
		StyleListItem View { get; set; }
